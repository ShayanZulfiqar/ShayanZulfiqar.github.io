...
const ShopHeroLoader = () => {
  return (
    <StyledWrapper>
      <div className="rings anim-pan">
        <div style={{ "--delay": "6" } as CSSProperties} className="ring anim-zoomIn" />
        <div style={{ "--delay": "4" } as CSSProperties} className="ring anim-zoomIn" />
        <div style={{ "--delay": "3" } as CSSProperties} className="ring anim-zoomIn" />
        <div style={{ "--delay": "2" } as CSSProperties} className="ring anim-zoomIn" />
        <div style={{ "--delay": "1" } as CSSProperties} className="ring anim-zoomIn" />
        <div style={{ "--delay": "0" } as CSSProperties} className="ring anim-zoomIn" />
      </div>
    </StyledWrapper>
  );
}
