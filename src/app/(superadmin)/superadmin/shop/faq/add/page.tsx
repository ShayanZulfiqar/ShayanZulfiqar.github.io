...
import { createFaqAction } from "@/store/slices/shopSlice";
...
const AddFaqPage = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setLoading(true);
        try {
            await dispatch(createFaqAction(data)).unwrap();
            AlertDialog("Success!", "FAQ created successfully.", "success", 3000, false, false);
                    ...
                    <div className="flex items-center gap-4 mb-10">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 font-medium">
                                Add a new frequently asked question to the shop
                            </p>
                        </div>
                    </div>
