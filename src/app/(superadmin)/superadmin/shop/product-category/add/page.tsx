...
import { createCategoryAction } from "@/store/slices/shopSlice";
...
const AddProductCategory = () => {
    ...
    const onSubmit = async (data: ProductCategoryInput) => {
        ...
        try {
            ...
            await dispatch(createCategoryAction(finalData)).unwrap();
            AlertDialog("Success", "Category created successfully", "success");
